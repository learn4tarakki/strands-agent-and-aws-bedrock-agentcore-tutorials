# Tutorial 01 — Strands Agents + AWS Bedrock AgentCore

Code for the first YouTube tutorial in the series — building AI agents with [Strands Agents](https://github.com/strands-agents/sdk-python) and deploying to AWS Bedrock AgentCore.
